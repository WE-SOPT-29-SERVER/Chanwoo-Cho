...
const cors = require("cors"); //  자신이 속하지 않은 다른 도메인, 다른 프로토콜, 다른 포트에 있는 리소스를 요청하는 cross-origin HTTP요청 방식
...
// 라우팅: routes 폴더로 관리
/** 전체적인 흐름 :
 * routes/index.js -- authRouter -- authController -- authService
 * -- 
 */
